...
if [ $# -gt 0 ]; then PROVE=("$@"); else PROVE=(prova-b1.js prova-stampa.js prova-b2.js prova-banco-avvio.js prova-banco-contenuto.js prova-banco-ripristino.js prova-banco-griglia.js prova-media-punto.js prova-menu.js prova-selezione-menu.js prova-note.js prova-keyword.js prova-mappe-ui.js prova-mappa-trascina.js prova-topbar.js prova-topbar-stile.js prova-tbar.js prova-appunti-barra.js prova-maniglia-indice.js prova-wikilink.js prova-identita-capitoli.js prova-pdf.js prova-confronto.js prova-testolayer.js prova-album.js prova-album-trascina.js prova-foto.js prova-memorie.js prova-tendine.js prova-modo.js prova-zaino.js prova-evidenze-pdf.js prova-fonti.js prova-fonte-rimossa.js prova-import.js prova-ocr-zaino.js prova-player.js prova-ripasso.js prova-ripasso-vista.js prova-crediti.js prova-impostazioni-token.js prova-onboarding-token.js prova-atlante.js prova-emoji.js); fi
