 ...
 *  Electron: una mappa è lavoro dell'utente, e deve poter tornare dal Cestino
 *  di sistema come i documenti (`fonti.elimina` è il fratello maggiore). Il
...
function rimuovi(vaultPath, courseId, file, opt) {
  const o = opt || {};
  if (typeof o.cestina === 'function') {
    ...
    return Promise.resolve().then(() => o.cestina(p)).then(() => true, () => false);
  }
